...
public partial class hrisDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employees>(entity =>
        {
            ...
            entity.HasOne(d => d.IdDeptNavigation).WithMany(p => p.Employees)
        ...
        modelBuilder.Entity<Projects>(entity =>
        {
            ...
            entity.HasOne(d => d.IdDeptNavigation).WithOne(p => p.Projects)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_id_dept");

            entity.HasOne(d => d.IdLocationNavigation).WithOne(p => p.Projects)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_id_location");
        });
